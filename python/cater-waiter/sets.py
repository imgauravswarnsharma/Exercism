...
def check_drinks(drink_name, drink_ingredients):
    ...
    if set(drink_ingredients).isdisjoint(ALCOHOLS):
        return str(f"{drink_name} Mocktail")
    return str(f"{drink_name} Cocktail")
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    """
    for i, name in ((VEGAN, "VEGAN"), (VEGETARIAN, "VEGETARIAN"), (PALEO, "PALEO"), (KETO, "KETO"), (OMNIVORE, "OMNIVORE")):
        if set(dish_ingredients).issubset(set(i)):
